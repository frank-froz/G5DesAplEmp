...
urlpatterns = [
    ...
    path('books/<int:book_id>/add_to_reading_list/', views.add_to_reading_list, name='add_to_reading_list'),

    path('reading-list/', views.reading_list_view, name='reading_list_view'),
